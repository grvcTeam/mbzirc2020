...
#ifndef PCL_ROS_POSE_ESTIMATOR_H_
#define PCL_ROS_POSE_ESTIMATOR_H_
...
#include <pcl/io/pcd_io.h>
#include <pcl/point_types.h>
// #include <example_srv/simple_bool_service_message.h>
...
{
public:
    PoseEstimator(ros::NodeHandle* nodehandle); //"main" will need to instantiate a ROS nodehandle, then pass it to the constructor
    void execute();
