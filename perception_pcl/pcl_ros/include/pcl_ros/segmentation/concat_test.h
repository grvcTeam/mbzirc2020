...
#ifndef PCL_ROS_CONCAT_TEST_H_
#define PCL_ROS_CONCAT_TEST_H_
...
{
public:
    ConCat(ros::NodeHandle* nodehandle); //"main" will need to instantiate a ROS nodehandle, then pass it to the constructor
    void execute();
...
private:
    ...
    sensor_msgs::PointCloud2 FilterCloud(const sensor_msgs::PointCloud2& msg);
