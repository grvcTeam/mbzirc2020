...
field_width = 100  # TODO: should be 60
field_height = 60  # TODO: should be 50
...
class CentralUnit(object):
    def __init__(self):
        # Force id to be a string to avoid index confussion  # TODO: auto discovery (and update!)
    ...
    def look_for_targets(self):
        ...
        for i, robot_id in enumerate(self.available_robots):
            ...
            for point in point_path:
                ...
                waypoint.pose.orientation.w = 1  # TODO: Forward Direction
        ...
        # Pursue Drone or Destroy Balloons
...
def main():
    rospy.init_node('central_unit_c1')
