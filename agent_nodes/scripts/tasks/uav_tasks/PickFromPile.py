...
class Task(smach.State):
    ...
    def __init__(self, name, interface, uav_ns, z_offset):
        ...
        # sub_tasks
        add_sub_task('pick_task', self, PickObject, task_args = [uav_ns, z_offset])
        add_sub_task('go_task', self, GoToWaypoint, task_args = [uav_ns])
    ...
    def execute(self, userdata):
        ...
        pose = Pose(position=Point(userdata.pile_centroid.x-0.5,userdata.pile_centroid.y,self.props['height']),
