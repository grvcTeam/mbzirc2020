...
#import mir_pregrasp_planning.cfg.PregraspPlannerParams as AngleConfig
...
class PregraspPlanner(object):
    ...
    def __init__(self):
        ...
        self.min_azimuth = rospy.get_param('~min_azimuth', 0.0)
        self.max_azimuth = rospy.get_param('~max_azimuth', 0.0)
        self.min_zenith = rospy.get_param('~min_zenith', 0.0)
        self.max_zenith = rospy.get_param('~max_zenith', 0.0)
        self.min_roll = rospy.get_param('~min_roll', 0.0)
        self.max_roll = rospy.get_param('~max_roll', 0.0)
